// app/dashboard/my-video-bookings/_components/BookingsTable.tsx
...
import { MoreHorizontal, Eye, XCircle, Calendar } from "lucide-react";
...
export default function BookingsTable({ initialData }: BookingsTableProps) {
  ...
  const columns: ColumnDef<any>[] = [
    ...
    },
    {
      ...
      id: "time", // 👈 unique id
      header: "Time",
      cell: ({ row }) => formatTime(row.original.scheduledAt),
    },
    {
