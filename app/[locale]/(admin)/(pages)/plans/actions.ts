...
const planSchema = z.object({
  ...
  price: z.coerce.number().min(0, { message: 'Price must be zero or positive' }), // 👈 changed
...
// -----------------------------------------------
// TYPES FOR GET PLANS WITH PAGINATION, SORTING, SEARCH 
// -----------------------------------------------
type GetPlansParams = {
  page?: number
  pageSize?: number
...
// -----------------------------------------------
// GET PLAN WITH PAGINATION, SORTING, SEARCH
// -----------------------------------------------
