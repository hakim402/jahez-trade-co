            ...
            <div className="flex items-center gap-4">
              ...
              <div className="relative">
                ...
                <div className="relative flex h-14 w-14 items-center justify-center rounded-2xl bg-linear-to-br from-color/30 to-color/10 border border-color/20 shadow-lg shadow-color/10">
                  <Video size={24} className="text-color" />
                </div>
              </div>
              ...
              <div>
                <div className="flex items-center gap-2 mb-0.5">
                  ...
                  {kpi.pending > 0 && (
                    <span className="inline-flex items-center gap-1 h-5 px-2 text-[10px] font-bold rounded-full bg-amber-400/15 text-amber-400 border border-amber-400/20 animate-pulse">
                      {kpi.pending} pending
                    </span>
                  )}
                </div>
