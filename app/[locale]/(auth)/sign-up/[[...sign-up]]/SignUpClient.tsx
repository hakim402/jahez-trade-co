...
// app/[locale]/(auth)/sign-up/[[...sign-up]]/SignUpClient.tsx
...
export function SignUpClient({ locale, isAr }: SignUpClientProps) {
  // Business translations
  const content = {
    en: {
      brand: "JAHEZ",
      tagline: "China Sourcing & Global Trade",
      welcome: "Join the Global Trade Network",
      subtitle:
        "Create your account to start sourcing products from China, managing imports to the USA, UAE, Dubai & Yemen, and scaling your business internationally.",
      features: [
    ...
    ar: {
      ...
      welcome: "انضم إلى شبكة التجارة العالمية",
      subtitle:
        "أنشئ حسابك لبدء التوريد من الصين، وإدارة الواردات إلى الولايات المتحدة والإمارات ودبي واليمن، وتوسيع أعمالك دولياً.",
      features: [
      ...
      <div className="relative flex min-h-[calc(100vh-80px)]">
        ...
        >
          ...
          <div className="absolute inset-0 bg-linear-to-br from-indigo-950 via-indigo-900 to-slate-950 dark:from-indigo-950 dark:via-slate-900 dark:to-slate-950">
            ...
            {/* "Join Now" floating badge */}
            <div className="absolute top-1/3 left-8 bg-indigo-500/20 backdrop-blur-sm rounded-full px-4 py-1.5 border border-indigo-400/30 animate-float">
              <span className="text-indigo-200 text-xs font-medium tracking-wider">
                {isAr ? "انضم إلى 10,000+ مستورد" : "Join 10,000+ Importers"}
              </span>
            </div>
          </div>
            ...
            <SignUp
              appearance={{
                elements: {
                  ...
                  dividerText:
                    "!text-slate-500 dark:!text-slate-400 !text-xs !uppercase !tracking-wider",
                  formFieldLabel:
