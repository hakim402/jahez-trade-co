        ...
        >
          ...
          <div className="relative z-10 flex flex-col justify-between p-12 xl:p-16 text-white">
            ...
            <div className="space-y-6 animate-slide-in-left delay-200">
              ...
              >
                {isAr
                  ? "ابدأ رحلتك مع جاهز اليوم"
                  : "Start your journey with JAHEZ today"}
              </h2>
              <p
              ...
              >
                {isAr
                  ? "انضم إلى آلاف المستخدمين واستفد من عروض حصرية، منتجات مميزة، وخدمة استثنائية."
                  : "Join thousands of users and enjoy exclusive deals, premium products, and exceptional service."}
              </p>
            </div>
            ...
            <div className="flex items-center gap-8 animate-slide-in-left delay-300">
              <div className="flex items-center gap-2">
                ...
                <span
                  ...
                  style={{ fontFamily: "'DM Sans', sans-serif" }}
                >
                  {isAr ? "تسجيل سهل وسريع" : "Quick & Easy Sign Up"}
                </span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-10 h-10 rounded-full bg-indigo-500/20 flex items-center justify-center">
