                    ...
                    <div className="relative py-36">
                        <div className="relative z-10 mx-auto w-full max-w-5xl px-6">
                            <div className="md:w-1/2">
                                <div>
                                    <h1 className="max-w-md text-balance text-5xl font-medium md:text-6xl">Get Job Ready with AI.</h1>
                                    <p className="text-muted-foreground my-8 max-w-2xl text-balance text-xl">Skillora helps freshers create professional career profiles, and build confidence using AI all in one simple platform</p>
